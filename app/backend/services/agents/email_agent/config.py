...
# Repo root is assumed to be 5 parents up from this file (app/backend/services/agents/email_agent -> repo root).
...
GMAIL_CREDENTIALS_FILE = _abs_path(os.environ.get("GMAIL_CREDENTIALS_FILE", "app/backend/gmail_oauth_credentials.json"))
GMAIL_TOKEN_FILE = _abs_path(os.environ.get("GMAIL_TOKEN_FILE", "app/backend/gmail_token.json"))
